        ...
        <div className="flex items-center gap-2">
          ...
          <div className="flex bg-gray-100 rounded-lg p-0.5">
            ...
            <button
              ...
              className={`p-1.5 rounded-md transition-colors ${
                viewMode === 'grouped' ? 'bg-white shadow-sm text-blue-600' : 'text-gray-400 hover:text-gray-600'
              }`}
      ...
      <div className="flex-1 overflow-y-auto px-5 py-4 space-y-4">
        ...
        {!isLoading && !error && searchResult && searchResult.items.length === 0 && (
          <div className="flex flex-col items-center justify-center py-16 text-gray-400">
            ...
            <p className="text-sm font-medium text-gray-500 capitalize">No hay {itemLabelPlural} en esta zona</p>
            <p className="text-xs text-gray-400 mt-1">Prueba con otros filtros o amplía el área de búsqueda</p>
          </div>
        )}
