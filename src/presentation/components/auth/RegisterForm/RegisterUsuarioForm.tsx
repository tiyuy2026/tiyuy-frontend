...
export const RegisterUsuarioForm: React.FC = () => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    e.preventDefault();
    if (googleData) {
      // Registro con Google: usar loginWithGoogle (el backend registra o loguea con uid)
    ...
    <div className="w-full">
      ...
      <form onSubmit={handleSubmit} noValidate>
        ...
        {currentStep === 1 && (
          <div className="space-y-5">
            <div className="text-center mb-6">
              ...
              <p className="text-sm text-gray-500">Tu email y contraseña para ingresar a la plataforma</p>
            </div>
        ...
        {currentStep === 3 && (
          <div className="space-y-5">
            <div className="text-center mb-6">
              <h3 className="text-lg font-semibold text-gray-800">¡Todo listo!</h3>
              <p className="text-sm text-gray-500">Revisa tus datos y crea tu cuenta</p>
            </div>
            ...
            <div className="bg-gray-50 rounded-xl p-5 space-y-3 border border-gray-200">
              ...
              {googleData && (
                <div className="flex justify-between text-sm">
                  ...
                  <span className="font-medium text-green-700">Google</span>
                </div>
              )}
              <div className="flex justify-between text-sm">
