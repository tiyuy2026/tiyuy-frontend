...
export const ProfileCard: React.FC<ProfileCardProps> = ({ profile, isSelected, onClick }) => {
  ...
  return (
    <Card hover onClick={() => onClick(profile)} className={`${isSelected ? 'ring-4 ring-blue-500 ring-offset-2' : ''}`}>
      {profile === 'DEVELOPER' && (
      ...
      <div className={`w-16 h-16 rounded-2xl ${config.color} bg-opacity-10 flex items-center justify-center mb-4`}>
