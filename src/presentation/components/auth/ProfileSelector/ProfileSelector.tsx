  ...
  return (
    <div className="min-h-screen py-4 sm:py-8 lg:py-12">
      <div className="text-center mb-8 sm:mb-12 lg:mb-16 px-4">
        <h1 className="text-2xl sm:text-3xl md:text-4xl lg:text-5xl font-bold text-gray-900 mb-3 sm:mb-4">Elige tu perfil</h1>
      ...
      <div className="text-center mt-6 sm:mt-8 lg:mt-12 px-4 sm:px-6 lg:px-8">
        <p className="text-sm sm:text-base text-gray-600">
          ¿Ya tienes cuenta?{' '}
          <Link href="/login" className="text-blue-600 hover:text-blue-700 font-semibold text-sm sm:text-base">
            Inicia sesión aquí
          </Link>
        </p>
      </div>
