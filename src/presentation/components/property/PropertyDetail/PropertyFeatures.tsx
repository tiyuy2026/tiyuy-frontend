...
const BedIcon = () => <Bed className="w-5 h-5 text-gray-500" />;
const BathIcon = () => <Bath className="w-5 h-5 text-gray-500" />;
const AreaIcon = () => <Maximize2 className="w-5 h-5 text-gray-500" />;
const CarIcon = () => <Car className="w-5 h-5 text-gray-500" />;
const FloorIcon = () => <Layers className="w-5 h-5 text-gray-500" />;
const CalendarIcon = () => <Calendar className="w-5 h-5 text-gray-500" />;
