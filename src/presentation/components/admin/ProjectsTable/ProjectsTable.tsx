...
import { Eye, Pencil, Pause, Trash2, MapPin, ChevronUp, ChevronDown } from 'lucide-react';
                ...
                <td className="px-4 py-4">
                  <div className={`flex items-center gap-1 transition-opacity ${isHovered ? 'opacity-100' : 'opacity-70'}`}>
                    ...
                    {onToggleFeatured && (
                      ...
                      >
                        <svg className="w-4 h-4" fill={project.isFeatured ? 'currentColor' : 'none'} viewBox="0 0 24 24" stroke="currentColor">
