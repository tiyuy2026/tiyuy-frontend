  ...
  categories: [
    {
      ...
      desc: "Nombre, apellido, correo electrónico, número de teléfono, documento de identidad (DNI/RUC), fotografía de perfil y datos de registro de cuenta.",
      iconType: "user"
    },
    {
      title: "Datos de propiedades",
      desc: "Información de inmuebles publicados: dirección, características, fotografías, precios, descripción y datos de ubicación geográfica.",
      iconType: "property"
    },
    {
      title: "Datos de uso y navegación",
      desc: "Direcciones IP, tipo de navegador, páginas visitadas, tiempo de permanencia, clics, búsquedas realizadas, interacciones con publicaciones y preferencias de navegación.",
      iconType: "navigation"
    },
    {
      title: "Datos de pago",
      desc: "Información de transacciones, historial de pagos, suscripciones y datos de facturación. Nota: No almacenamos datos completos de tarjetas de crédito; estos son procesados por pasarelas de pago certificadas PCI-DSS.",
      iconType: "payment"
    }
  ],
  uses: [
          ...
          <main className="flex-1 min-w-0 max-w-4xl">
            <div className="prose prose-lg max-w-none">
              ...
              <section id="security" className="mb-12 scroll-mt-24">
                <SectionHeader num={6} title="Seguridad de tus datos" />
