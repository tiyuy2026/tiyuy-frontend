 ...
 * Agents can create, edit, and delete their banners
 */
...
import {
  useAgentMyBanners,
  useAgentCreateBanner,
  useAgentUpdateBanner,
  useAgentDeleteBanner,
...
export default function AgentMarketingBannersPage() {
  ...
  const updateMutation = useAgentUpdateBanner();
  const deleteMutation = useAgentDeleteBanner();
