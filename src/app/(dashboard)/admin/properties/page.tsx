      ...
      {selectedProperty && (
        <Modal isOpen={isDisableModalOpen} onClose={() => setIsDisableModalOpen(false)}>
          <div className="bg-white rounded-lg p-4 sm:p-6 max-w-md w-full mx-2 sm:mx-0">
            <h3 className="text-base sm:text-lg font-semibold mb-2 text-gray-900">Deshabilitar Propiedad</h3>
            <p className="text-xs sm:text-sm text-gray-600 mb-3 sm:mb-4">
              Esta acción deshabilitará la propiedad <strong className="break-words">{selectedProperty.title}</strong> del propietario <strong>{selectedProperty.ownerName}</strong>.
            </p>
            ...
            <div className="mb-3 sm:mb-4">
              ...
              <textarea
                ...
                rows={3}
                className="w-full px-2.5 sm:px-3 py-1.5 sm:py-2 text-xs sm:text-sm border border-gray-300 rounded-md focus:ring-2 focus:ring-red-500 focus:border-red-500"
                placeholder="Ej: La propiedad incumple las políticas de publicación..."
                required
              />
            </div>

            <div className="bg-red-50 border border-red-200 rounded-md p-2.5 sm:p-3 mb-3 sm:mb-4">
...
function ModerationModal({ property, onConfirm, onCancel }: ModerationModalProps) {
  ...
  return (
    <div className="bg-white rounded-lg p-4 sm:p-6 max-w-md w-full mx-2 sm:mx-0">
      <h3 className="text-base sm:text-lg font-semibold mb-3 sm:mb-4">Moderar Propiedad</h3>

      <div className="mb-3 sm:mb-4">
        <div className="text-xs sm:text-sm text-gray-600 mb-2">
          Moderando: <strong className="break-words">{property.title}</strong>
        </div>
        ...
        <form onSubmit={handleSubmit} className="space-y-3 sm:space-y-4">
          ...
          <div className="flex flex-col sm:flex-row gap-2 sm:gap-3 pt-3 sm:pt-4">
            <Button type="submit" variant={action === 'APPROVE' ? 'primary' : 'danger'} className="text-xs sm:text-sm w-full sm:w-auto">
