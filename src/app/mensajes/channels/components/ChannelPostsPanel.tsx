          ...
          <div key={`share-${post.id}`} className="fixed right-8 bottom-20 z-50">
            <div className="bg-white rounded-xl p-6 max-w-md w-96 shadow-2xl border border-gray-200">
              ...
              <div className="grid grid-cols-5 gap-3">
                ...
                >
                  <svg className="w-6 h-6 text-brand mb-1" fill="currentColor" viewBox="0 0 24 24">
                ...
                >
                  <svg className="w-6 h-6 text-brand-dark mb-1" fill="currentColor" viewBox="0 0 24 24">
