            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 sm:gap-8">
              {quickLinks.map(({ href, icon, title, description, actionText }) => (
                <Link key={href} href={href} className="block group h-full">
                  <div className="flex flex-col h-full bg-[var(--bg-secondary)] rounded-xl p-6 sm:p-10 shadow-sm border-2 border-[var(--border-color)] hover:border-[var(--brand-primary)] hover:bg-[var(--bg-card)] group-hover:scale-[1.02] transition-all duration-300">
                    <div className="flex-grow">
                      {/* Contenedor dinámico del Icono */}
                      <div className="w-12 h-12 sm:w-14 sm:h-14 bg-[var(--brand-primary-light)] rounded-xl flex items-center justify-center mb-5 group-hover:bg-[var(--brand-primary-light-hover)] transition-colors">
                        <Icon icon={icon} className="w-6 h-6 sm:w-7 sm:h-7 text-[var(--brand-primary)]" />
                      </div>
                      
                      <h3 className="text-lg sm:text-xl font-bold text-[var(--text-primary)] mb-3 group-hover:text-[var(--brand-primary)] transition-colors">
                        {title}
                      </h3>
                    ...
                    <div className="flex items-center gap-2 text-[var(--brand-primary)] font-semibold text-xs sm:text-sm pt-2">
